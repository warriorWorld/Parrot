...
import com.harbinger.parrot.adapter.OnlyTextListAdapter;
...
public class ListDialog extends Dialog implements View.OnClickListener {
    ...
    public ListDialog(Context context, String[] list) {
        super(context);
        this.context = context;
        this.list = list;
    }
            ...
            optionsLv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                    if (null != mOnRecycleItemLongClickListener) {
                        if (null != list && list.length > 0) {
                            mOnRecycleItemLongClickListener.onItemClick(position);
                            dismiss();
                        }
                        return true;
                    } else {
